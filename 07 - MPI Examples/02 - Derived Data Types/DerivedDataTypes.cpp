...
int main( int argc, char *argv[])
{
	...
	// инициализаци€ MPI (создание процессов)
	MPI_Init(&argc, &argv);

	// идентификаци€ текущего процесса
	MPI_Comm_rank(MPI_COMM_WORLD, &myrank);
	MPI_Comm_size(MPI_COMM_WORLD, &nprocs);

	// объ€вление наследуемых типов данных
	...
	if (myrank == 0)
	{
		// инициализаци€ исходного вектора
	...
	{
		// выделение пам€ти под буфер приемника
